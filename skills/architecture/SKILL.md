---
name: architecture
description: Create or update ARCHITECTURE.md — system design, tech stack, domain model, key decisions
metadata:
  version: "1.0"
  author: rodacato
  triggers:
...
Create or update `docs/ARCHITECTURE.md` — system design, tech stack, domain model, key
decisions. This is the blueprint someone reads to understand the ENTIRE system without
...
Update `.launchpad/manifest.yml` — set `architecture: "1.0"` under `modules:`.
