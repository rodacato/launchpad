# Workflow — Base Process

> This is the base workflow managed by the launchpad template.
> Do NOT edit this file in projects — it gets overwritten by template sync.
> Project-specific customizations go in `docs/WORKFLOW.md`.
...
Run the project's test suite, update docs, open PR. See Definition of Done in `docs/WORKFLOW.md`.
...
in `.launchpad/AGENTS.md`), it triggers sprint planning. This is a CONVERSATION — the agent
...
Triggered by: "escribi una spec para X" / "write a spec for X"
...
Triggered by: "documentemos esta decision" / "let's write an ADR"
