...
`.notdefined.yml` — Project metadata for the rodacato showroom
(rodacato.github.io/projects). Defines tagline, description, stack, status,
icon, screenshot, and links.
...
Use the template at `modules/docs/notdefined/template.md` as base.
...
- Add `notdefined: "1.0"` under `modules:`
