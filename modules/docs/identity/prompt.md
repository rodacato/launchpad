...
`docs/IDENTITY.md` — The Build Identity. The technical persona the agent embodies
when working on this project. Not the human — the ideal fractional CTO / staff engineer
whose judgment best serves this project's success.
...
Write the full identity using the template at `modules/identity/template.md`.
...
3. Check the template for new sections:
   `https://raw.githubusercontent.com/rodacato/launchpad/master/modules/identity/template.md`
...
- Add `identity: "1.0"` under `modules:`
