...
`docs/VISION.md` — The project compass. Every feature decision, every scope debate,
...
No prerequisites — this is usually the first module. If `CLAUDE.md` exists,
...
Write the full vision using the template at `modules/vision/template.md`.
...
3. Check the template for new sections:
   `https://raw.githubusercontent.com/rodacato/launchpad/master/modules/vision/template.md`
